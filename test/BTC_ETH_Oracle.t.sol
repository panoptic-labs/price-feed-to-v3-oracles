...
contract PythToV3OracleTest is Test {
    ...
    // https://app.uniswap.org/explore/pools/unichain/0x764afe9ab22a5c80882918bb4e59b954912b17a22c3524c68a8cf08f7386e08f
    PoolId ethBtcv4PoolId = PoolId.wrap(0x764afe9ab22a5c80882918bb4e59b954912b17a22c3524c68a8cf08f7386e08f);

    // From: https://www.pyth.network/developers/price-feed-ids
    bytes32 ethBtcPriceFeedId = 0xc96458d393fe9deb7a7d63a0ac41e2898a67a7750dbd166673279e06c868df0a;
    ...
    int8 decimalDifferenceFromToken0ToToken1 = -10;
    ...
    function setUp() public {
        ...
        oracle =
            new PythToV3Oracle(pyth, ethBtcPriceFeedId, maxPythPriceAge, decimalDifferenceFromToken0ToToken1, shouldInvert);
    }
    ...
    function testPriceComparisonWithUniswapPool() public {
        ...
        (, int24 poolTick,,) = stateView.getSlot0(ethBtcv4PoolId);
    ...
    function testRevertOnStalePriceAndAcceptsAllOthers(uint256 secondsInFuture) public {
        ...
        PythStructs.Price memory price = pyth.getPriceUnsafe(ethBtcPriceFeedId);
