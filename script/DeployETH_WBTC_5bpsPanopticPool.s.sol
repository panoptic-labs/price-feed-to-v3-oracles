...
contract DeployETH_WBTC_5bpsPanopticPool is Script {
    ...
    function run() external {
        ...
        PoolKey memory poolKey = PoolKey({
            currency0: Currency.wrap(ETH < WBTC ? ETH : WBTC), // Ensure currency0 < currency1
        ...
        // Salt retrieved using ./MineETH_WBTC_5bpsPanopticPoolDeploymentSalt.s.sol
        uint96 salt = 2065587;
